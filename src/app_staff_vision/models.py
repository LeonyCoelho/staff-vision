...
class Theme(models.Model):
    ...
    theme_url= models.CharField(max_length=50, default="css/default.css")
    def __str__(self):
...
class Global_Settings(models.Model):
    ...
    logo_image =  models.ImageField(upload_to='logos/uploaded_logo', null=True)
    bg_image =  models.ImageField(upload_to='bgs/uploaded_bgs', null=True)
